...
| Desktop/mobile real UI screenshots | **VISUAL VERIFIED** under the documented fallback condition |
...
The release status is therefore **READY WITH LIMITATIONS**. See [`STATUS.md`](STATUS.md), [`docs/TESTING.md`](docs/TESTING.md) and [`docs/RELEASE_CONTRACT.md`](docs/RELEASE_CONTRACT.md).
...
- [`docs/RELEASE_STANDARD.md`](docs/RELEASE_STANDARD.md) — project-local V4.1 release standard;
