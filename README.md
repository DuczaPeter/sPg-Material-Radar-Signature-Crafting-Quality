...
| Desktop/mobile real UI screenshot | **VISUAL VERIFIED** a dokumentált fallback környezetben |
...
A release státusz ezért **READY WITH LIMITATIONS**. Részletek: [`STATUS.md`](STATUS.md), [`docs/TESTING.md`](docs/TESTING.md), [`docs/RELEASE_CONTRACT.md`](docs/RELEASE_CONTRACT.md).
...
- [`docs/RELEASE_STANDARD.md`](docs/RELEASE_STANDARD.md) — projektlokális release-szabvány, V4.1;
