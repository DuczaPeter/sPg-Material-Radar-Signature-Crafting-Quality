...
| Savrilium | Ship | ≤6.8% / 2. tier ≤0.3% | Breaker Stations Large Geode; 2. tier: Glaciem Ring; Keeger Belt | `Képernyőkép 2026-08-24 183900.png` | Az első tier Event. A második legjobb Nyx tier célzott közös lelőhely-kereséshez szándékosan megmarad. |
...
## Kivétel a Target Mining közös hely kereséséhez

- **Savrilium / Nyx:** az első tier `Breaker Stations Large Geode · ≤6.8%`, de a második legjobb tier is megmarad: `Glaciem Ring · Keeger Belt · ≤0.3%`.
- Ennek oka, hogy a Célzott bányászat közös lelőhely-keresése így képes felismerni a valós közös Nyx helyeket például Lindiniummal.
- Ez célzott, forrásképpel igazolt kivétel; más anyagra nem kell automatikusan kiterjeszteni.
