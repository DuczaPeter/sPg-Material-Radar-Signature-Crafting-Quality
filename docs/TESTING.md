...
- canonical V4.2 standard presence, version and SHA-256;
- `.gitattributes` line-ending policy and CRLF-free inventoried text files;
- existence of every inventoried and checksummed file, including dot-prefixed files;
